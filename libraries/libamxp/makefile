...
install: all
	$(INSTALL) -d -m 0755 $(DEST)/$(INCLUDEDIR)/amxp
	$(INSTALL) -D -p -m 0644 include/amxp/*.h $(DEST)$(INCLUDEDIR)/amxp/
...
package: all
	$(INSTALL) -d -m 0755 $(PKGDIR)/$(INCLUDEDIR)/amxp
	$(INSTALL) -D -p -m 0644 include/amxp/*.h $(PKGDIR)$(INCLUDEDIR)/amxp/
