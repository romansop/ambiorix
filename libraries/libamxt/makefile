...
install: all
	$(INSTALL) -d -m 0755 $(DEST)/$(INCLUDEDIR)/amxt
	$(INSTALL) -D -p -m 0644 include/amxt/*.h $(DEST)$(INCLUDEDIR)/amxt/
...
package: all
	$(INSTALL) -d -m 0755 $(PKGDIR)/$(INCLUDEDIR)/amxt
	$(INSTALL) -D -p -m 0644 include/amxt/*.h $(PKGDIR)$(INCLUDEDIR)/amxt/
