...
install: all
	$(INSTALL) -d -m 0755 $(DEST)/$(INCLUDEDIR)/amxb
	$(INSTALL) -D -p -m 0644 include/amxb/*.h $(DEST)$(INCLUDEDIR)/amxb/
...
package: all
	$(INSTALL) -d -m 0755 $(PKGDIR)/$(INCLUDEDIR)/amxb
	$(INSTALL) -D -p -m 0644 include/amxb/*.h $(PKGDIR)$(INCLUDEDIR)/amxb/
