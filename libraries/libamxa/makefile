...
install: all
	$(INSTALL) -d -m 0755 $(DEST)/$(INCLUDEDIR)/amxa
	$(INSTALL) -D -p -m 0644 include/amxa/*.h $(DEST)$(INCLUDEDIR)/amxa/
...
package: all
	$(INSTALL) -d -m 0755 $(PKGDIR)/$(INCLUDEDIR)/amxa
	$(INSTALL) -D -p -m 0644 include/amxa/*.h $(PKGDIR)$(INCLUDEDIR)/amxa/
