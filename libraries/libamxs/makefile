...
install: all
	$(INSTALL) -d -m 0755 $(DEST)/$(INCLUDEDIR)/amxs
	$(INSTALL) -D -p -m 0644 include/amxs/*.h $(DEST)$(INCLUDEDIR)/amxs/
...
package: all
	$(INSTALL) -d -m 0755 $(PKGDIR)/$(INCLUDEDIR)/amxs
	$(INSTALL) -D -p -m 0644 include/amxs/*.h $(PKGDIR)$(INCLUDEDIR)/amxs/
...
doc:
	mkdir -p output/doc
	VERSION=$(VERSION) doxygen doc/libamxs.doxy
