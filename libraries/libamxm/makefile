...
install: all
	$(INSTALL) -d -m 0755 $(DEST)/$(INCLUDEDIR)/amxm
	$(INSTALL) -D -p -m 0644 include/amxm/*.h $(DEST)$(INCLUDEDIR)/amxm/
...
package: all
	$(INSTALL) -d -m 0755 $(PKGDIR)/$(INCLUDEDIR)/amxm
	$(INSTALL) -D -p -m 0644 include/amxm/*.h $(PKGDIR)$(INCLUDEDIR)/amxm/
