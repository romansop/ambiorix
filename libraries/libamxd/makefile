...
install: all
	$(INSTALL) -d -m 0755 $(DEST)/$(INCLUDEDIR)/amxd
	$(INSTALL) -D -p -m 0644 include/amxd/*.h $(DEST)$(INCLUDEDIR)/amxd/
...
package: all
	$(INSTALL) -d -m 0755 $(PKGDIR)/$(INCLUDEDIR)/amxd
	$(INSTALL) -D -p -m 0644 include/amxd/*.h $(PKGDIR)$(INCLUDEDIR)/amxd/
