...
First off, thank you for considering contributing to amxo-xml-to and the [Ambiorix](https://gitlab.com/prpl-foundation/components/ambiorix) project. It's people like you that makes [Ambiorix](https://gitlab.com/prpl-foundation/components/ambiorix) such a great set of tools and libraries.
...
If you find yourself wishing for a feature that doesn't exist in Ambiorix (in general) or amxo-xml-to (specific), you are probably not alone. Open an issue/ticket which describes the feature you would like to see, why you need it, and how it should work.
